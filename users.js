    ...
    {id: 7, name: "providers", onlineID: "providers", rank: ranks.HeadAdmin, status: "offline", hash: "#6", permissions: permissions.none, ccj: ccj}, 7,
    ...
    {id: 10, name: "player2389", onlineID: "player2389", rank: ranks[0], status: "offline", hash: "#9", permissions: permissions.none, ccj: ccj}, 10]; const bots = [
    {id: "@+" + 1, name: "Arancia 3 Network Service Provider", onlineID: "[A3N]", rank: ranks.HeadAdmin, status: "offline", deadlineID: "23479394231798342748", hash: null, permissions: permissions.ban, ccj: ccj}, '@' + 1,
